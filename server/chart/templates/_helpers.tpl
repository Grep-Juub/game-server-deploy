...
helm.sh/chart: {{ include "gameserver.chart" . }}
...
{{/*
Basic exec prob for readiness and liveness
*/}}
{{- define "gameserver.shellProbe"}}
exec:
  command:
   - /usr/bin/local/probecheck
{{- end }}
